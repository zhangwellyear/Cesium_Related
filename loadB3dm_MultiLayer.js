 ...
 */
function getUrl() {
    var url1 = 'http://localhost:63342/b3dm/tileset.json';
    //var url2 = '../../Data/changshaAll/4001_1/tileset.json';
    //var url2 = 'http://localhost:63342/b3dm/3008_2/tileset.json';
    //var url3 = 'http://localhost:63342/b3dm/3008_3/tileset.json';
    //var url4 = 'http://localhost:63342/b3dm/3008_4/tileset.json';
    //var url5 = 'http://localhost:63342/b3dm/3008_5/tileset.json';

    //var urls = [url1, url2, url3, url4, url5];
    var urls = [url1];
    //var url3 = '../../Data/changshaAll/4001_2/tileset.json';
    //var url4 = '../../Data/changshaAll/4001_3/tileset.json';

    // var b3dm_url = '../../Data/changshaAll/4001_1/tileset.json';
...
// loadB3dm模型的总调用函数
function loadB3dm(viewer, Cesium) {
    var url_obj = getUrl();

    var cesium3DTileset = undefined;
    if (url_obj.CONFIG !== undefined) {
        cesium3DTileset = loadTiles_With_Height(url_obj, 32, Cesium);
    } else if (url_obj.MAX_LOAD_TILES) {
        cesium3DTileset = loadTiles_ManualeModel(url_obj, 32, Cesium);
    } else {
        cesium3DTileset = loadTiles_Plain(url_obj, 128, Cesium);
    }
...
// 最传统的方法加载.b3dm模型
function loadTiles_Plain(url, mSSE, Cesium) {
...
// 在加载模型时，调整高度
function loadTiles_With_Height(url, mSSE, Cesium) {
...
// 加载手工模型
function loadTiles_ManualeModel(url, mSSE, Cesium) {
