/**
 * Created by DBRG on 2018/9/13.
 */
function load3DTiles(viewer) {
    ...
    var tileset = new Cesium.Cesium3DTileset({
        url: '../../Data/citygml_ny/NewYork/tileset.json'
    });
    ...
    nameOverlay.style.background = 'black';
    ...
    // If silhouette are supported, silhouette feature in blue on mouse over and silhouette green on mouse click.
    // If silhouette are not supported, change the feature color to yellow on mouse over and green on mouse click.
    if (Cesium.PostProcessStageLibrary.isSilhouetteSupported(viewer.scene)) {
        // Silhouette are supported
        ...
        viewer.screenSpaceEventHandler.setInputAction(function onMouseOver(movement) {
        ...
        viewer.screenSpaceEventHandler.setInputAction(function onLeftClick(movement) {
            //　If a feature was previously, undo the highlight
            silhouetteGreen.selected = [];
